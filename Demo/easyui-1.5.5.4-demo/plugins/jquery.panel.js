...
if($(this).hasClass("easyui-可拖动box-O-fluid")||_1e){
_3(_1c,{});
}
return false;
});
...
if(_6f.length){
_6f.layout("resize");
$("body").children(".easyui-可拖动box-O-fluid:visible").each(function(){
...
var _7f=_7d==$("body")[0];
var s=$(_7d).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-可拖动box-O-fluid:visible").filter(function(_80,el){
