...
(function(){
	...
	var locales = {
		'af':'easyui-可拖动box-O-lang-af.js',
		'ar':'easyui-可拖动box-O-lang-ar.js',
		'bg':'easyui-可拖动box-O-lang-bg.js',
		'ca':'easyui-可拖动box-O-lang-ca.js',
		'cs':'easyui-可拖动box-O-lang-cs.js',
		'cz':'easyui-可拖动box-O-lang-cz.js',
		'da':'easyui-可拖动box-O-lang-da.js',
		'de':'easyui-可拖动box-O-lang-de.js',
		'el':'easyui-可拖动box-O-lang-el.js',
		'en':'easyui-可拖动box-O-lang-en.js',
		'es':'easyui-可拖动box-O-lang-es.js',
		'fr':'easyui-可拖动box-O-lang-fr.js',
		'it':'easyui-可拖动box-O-lang-it.js',
		'jp':'easyui-可拖动box-O-lang-jp.js',
		'nl':'easyui-可拖动box-O-lang-nl.js',
		'pl':'easyui-可拖动box-O-lang-pl.js',
		'pt_BR':'easyui-可拖动box-O-lang-pt_BR.js',
		'ru':'easyui-可拖动box-O-lang-ru.js',
		'sv_SE':'easyui-可拖动box-O-lang-sv_SE.js',
		'tr':'easyui-可拖动box-O-lang-tr.js',
		'zh_CN':'easyui-可拖动box-O-lang-zh_CN.js',
		'zh_TW':'easyui-可拖动box-O-lang-zh_TW.js'
	};
